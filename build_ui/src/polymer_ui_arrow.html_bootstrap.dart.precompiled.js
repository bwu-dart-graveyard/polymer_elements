...
$=I.p
var $$={}
;init.mangledNames={gCb:"_borders",gKM:"$",gMU:"__$size",gO3:"__$direction",gP:"value",gPO:"__$color",gXO:"_lefts",guR:"_updateJob",gvH:"index",gwk:"__$borderWidth",gwl:"_tops",gyP:"__$borderColor"};(function (reflectionData) {
  "use strict";
...
$isOd:true}}],["app_bootstrap","file:///home/zoechi/source/my/dart/polymer_ui_elements_pr/polymer_ui_elements_examples/web/polymer_ui_arrow.html_bootstrap.dart",,E,{
"^":"",
QL:[function(){$.x2=["package:polymer_ui_elements/polymer_ui_arrow/polymer_ui_arrow.dart","polymer_ui_arrow.html.0.dart"]
$.uP=!1
...
else return new P.ph(this,z)},"call$2$runGuarded","gzg",2,3,null,310,108,[],367,[]]},
TF:{
"^":"Tp:256;a,b",
...
qE:{
"^":"cv;",
"%":"HTMLAppletElement|HTMLBRElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLFontElement|HTMLFrameElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLMarqueeElement|HTMLMenuElement|HTMLModElement|HTMLOptGroupElement|HTMLParagraphElement|HTMLPreElement|HTMLQuoteElement|HTMLShadowElement|HTMLSpanElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableElement|HTMLTableHeaderCellElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTitleElement|HTMLUListElement|HTMLUnknownElement;HTMLElement;XP|Tt|GN|ir|LP|Ws"},
SV:{
"^":"Gv;",
$isList:true,
...
try{if(d==null)d=""
a.setProperty(b,c,d)
if(!!a.setAttribute)a.setAttribute(b,c)}catch(z){H.Ru(z)}},function(a,b,c){return this.hV(a,b,c,null)},"Ei","call$3",null,"gaX",4,2,null,76,62,[],22,[],266,[]],
...
hV:[function(a,b,c,d){this.FY.aN(0,new W.pV(b,c,d))},function(a,b,c){return this.hV(a,b,c,null)},"Ei","call$3",null,"gaX",4,2,null,76,62,[],22,[],266,[]],
...
E1:{
"^":"a;",
gkd:function(a){return this.T2(a,"border-color")},
...
gP:[function(a){return this.Sv},null,null,1,0,256,"value",404],
...
return z.gB(z)===0},null,null,1,0,348,"isEmpty",404],
gor:[function(a){var z=this.Zp
return z.gB(z)!==0},null,null,1,0,348,"isNotEmpty",404],
...
z=y==null?z!=null:y!==z}else z=!1
if(!z)this.ov()
return C.Nm.grZ(this.kN)},null,null,1,0,256,"value",404],
...
zM:[function(a){A.Vx(a,new A.Mq())},"call$1","jU",2,0,null,235,[]],
...
return y},function(a,b){return this.Wz(a,b,null)},"nP","call$2",null,"gpm",2,2,null,76,400,[],414,[]],
...
$isyL:true},
dM:{
"^":["a;KM:pM=-420",function(){return[C.nd]}],
...
w=t.u7
if(w!=null&&t.VP<=0)J.qV(t.uv,v,w,u)}},"call$3","gPm",6,0,null,235,[],428,[],271,[]],
...
this.ea(a,a,t,[b,typeof b==="object"&&b!==null&&!!z.$isHe?z.gey(b):null,a])}if(x)y.J4("<<< ["+this.gqn(a)+"]: hostEventListener("+H.d(z.gt5(b))+")")},"call$1","gD4",2,0,429,357,[]],
...
return a}}},
Tt:{
"^":["qE+dM;KM:pM=-420",function(){return[C.nd]}],
$isdM:true,
$ishs:true,
$iswn:true,
$iscv:true,
...
if(z)return
return new T.Xy(this,b,x)},"call$3","gca",6,0,436,236,[],11,[],235,[]],
...
gP:[function(a){return this.Y7},null,null,1,0,256,"value",404],
sP:[function(a,b){var z,y,x,w
try{K.jX(this.Cu,b,this.a9)}catch(y){x=H.Ru(y)
w=J.x(x)
if(typeof x==="object"&&x!==null&&!!w.$isB0){z=x
$.eH().j2("Error evaluating expression '"+H.d(this.Cu)+"': "+J.z2(z))}else throw y}},null,null,3,0,207,249,[],"value",404],
...
wL:{
"^":"a:207;UR,ex",
call$1:[function(a){return this.UR.F2(this.ex,[a],null).Ax},"call$1","gKu",2,0,null,437,[]],
$iswL:true,
$isEH:true},
B0:{
"^":"a;G1>",
...
Fq:{
"^":"a;",
Bf:[function(a,b,c){return new U.zX(b,c)},"call$2","gvH",4,0,438,17,[],121,[]],
...
xs:{
"^":"Tp:319;",
call$2:[function(a,b){return U.Zm(a,J.v1(b))},"call$2",null,4,0,null,439,[],440,[],"call"],
...
this.fL.G()},function(){return this.Gd(null,null)},"w5","call$2",null,"gnp",0,4,null,76,76,441,[],22,[]],
...
return a},"call$2","gHr",4,0,null,442,[],443,[]],
...
y=b.gre()
this.Sk.toString
return new U.Jy(a,z,y)}else throw H.b(Y.RV("expected identifier: "+H.d(b)))}},"call$2","gE3",4,0,null,442,[],444,[]],
...
this.Sk.toString
return new U.uk(x,a,y)},"call$1","gvB",2,0,null,442,[]],
...
y=H.VM(new U.no(z),[null])
this.w5()
return y},function(){return this.pT("")},"Ud","call$1",null,"gwo",0,2,null,307,445,[]],
yj:[function(a){var z,y
z=H.IH(H.d(a)+H.d(J.Vm(this.fL.lo)),null)
this.Sk.toString
y=H.VM(new U.no(z),[null])
this.w5()
return y},function(){return this.yj("")},"tw","call$1",null,"gSE",0,2,null,307,445,[]]}}],["polymer_expressions.src.globals","package:polymer_expressions/src/globals.dart",,K,{
"^":"",
...
bu:[function(a){return"("+H.d(this.vH)+", "+H.d(this.P)+")"},"call$0","gXo",0,0,448,"toString"],
$isAe:true,
...
fr:{
"^":"a;",
DV:[function(a){return J.UK(a,this)},"call$1","gnG",2,0,449,85,[]]},
Sa:{
"^":"fr;",
...
J.UK(a.gT8(a),this)
this.xn(a)},"call$1","gU6",2,0,null,255,[]]}}],["polymer_ui_elements.polymer_ui_arrow","package:polymer_ui_elements/polymer_ui_arrow/polymer_ui_arrow.dart",,E,{
"^":"",
Ws:{
"^":["LP;Cb%-76,wl%-76,XO%-76,O3%-450,MU%-451,PO%-450,yP%-450,wk%-451,uR%-76,AP,fn,AP,fn,nV,dn,HX,JF,Fj,MK,Wm,pM-420",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,function(){return[C.nd]}],
gCT:[function(a){return a.O3},null,null,1,0,448,"direction",404,452],
sCT:[function(a,b){a.O3=this.ct(a,C.ct,a.O3,b)},null,null,3,0,24,22,[],"direction",404],
gtL:[function(a){return a.MU},null,null,1,0,453,"size",404,452],
stL:[function(a,b){a.MU=this.ct(a,C.Aa,a.MU,b)},null,null,3,0,454,22,[],"size",404],
gih:[function(a){return a.PO},null,null,1,0,448,"color",404,452],
sih:[function(a,b){a.PO=this.ct(a,C.Dj,a.PO,b)},null,null,3,0,24,22,[],"color",404],
gkd:[function(a){return a.yP},null,null,1,0,448,"borderColor",404,452],
skd:[function(a,b){a.yP=this.ct(a,C.Bh,a.yP,b)},null,null,3,0,24,22,[],"borderColor",404],
gf8:[function(a){return a.wk},null,null,1,0,453,"borderWidth",404,452],
sf8:[function(a,b){a.wk=this.ct(a,C.ZE,a.wk,b)},null,null,3,0,454,22,[],"borderWidth",404],
I9:[function(a){this.DP(a)},"call$0","gaS",0,0,256,"ready"],
a2:[function(a){this.DP(a)},"call$0","gMk",0,0,256,"directionChanged"],
oE:[function(a){this.DP(a)},"call$0","gQD",0,0,256,"sizeChanged"],
Lr:[function(a){this.DP(a)},"call$0","geH",0,0,256,"colorChanged"],
yZ:[function(a){this.DP(a)},"call$0","gAA",0,0,256,"borderColorChanged"],
pU:[function(a){this.DP(a)},"call$0","gMJ",0,0,256,"borderWidthChanged"],
DP:[function(a){if(a.uR==null){P.rT(C.RT,this.gIE(a))
a.uR=null}},"call$0","gX3",0,0,256,"asyncUpdate"],
...
z.skd(x,"transparent")
y.skd(w,"transparent")
v=C.xB.g("border-",J.UQ(a.Cb,a.O3))+"-Color"
z.Ei(x,v,a.yP)
y.Ei(w,v,a.PO)
y.sG6(w,J.AG(J.p0(J.UQ(a.wl,a.O3),a.wk))+"px")
y.sBb(w,J.AG(J.p0(J.UQ(a.XO,a.O3),a.wk))+"px")},"call$0","gIE",0,0,256,"_update"],
"@":function(){return[C.bI]},
static:{MZ:[function(a){var z,y,x,w,v,u,t
z=H.B7(["up","Bottom","down","Top","left","Right","right","Left"],P.L5(null,null,null,null,null))
y=H.B7(["up",1,"down",-1,"left",0,"right",0],P.L5(null,null,null,null,null))
x=H.B7(["up",0,"down",0,"left",1,"right",-1],P.L5(null,null,null,null,null))
w=$.Nd()
...
C.n4.ZL(a)
C.n4.oX(a)
return a},null,null,0,0,256,"new PolymerUiArrow$created"]}},
"+PolymerUiArrow":[455],
LP:{
"^":"ir+Pi;",
...
"^":"Tp:207;a",
call$1:[function(a){var z=this.a
return z.EC(J.Vm(z.xS))},"call$1",null,2,0,null,464,[],"call"],
$isEH:true}}],])
...
C.NU=new P.R8()
C.v8=new P.AH()
C.bI=new A.V3("polymer-ui-arrow")
C.RT=new P.a6(0)
...
C.fz=new H.GD("[]")
C.Bh=new H.GD("borderColor")
C.ZE=new H.GD("borderWidth")
C.Ka=new H.GD("call")
C.Dj=new H.GD("color")
C.ct=new H.GD("direction")
...
$.uP=!0
$.To=null
$.Dq=["Ay","BN","BT","BX","Ba","Bf","C","C0","Ch","D","D3","D6","DP","E","Ec","Ei","F","FL","Fr","GB","GG","HG","Hn","I9","Id","Ih","Is","J","J2","J3","JP","JT","JV","Ja","Jk","Kb","LV","Lr","Md","Mi","Mu","NZ","Nj","O","On","PM","PZ","Pa","Pk","Pv","Qi","R3","RB","RR","Rg","Rz","SZ","T","T2","TP","TW","Tc","Tk","Tp","U","UD","UH","UZ","Uc","V","V1","Vk","Vr","W","W3","W4","WO","Wt","Wz","XG","XL","XU","Xl","Y9","YU","YW","Z","Z1","Z2","ZL","Zv","a2","aC","aN","bA","bS","br","bu","cO","cU","cn","ct","d0","dR","dd","du","eR","ea","ek","er","es","ev","ez","f6","fd","fk","fm","g","gA","gAd","gB","gBb","gCT","gCb","gCd","gCj","gDD","gDg","gEX","gFV","gG0","gG1","gG3","gGL","gHs","gI","gIt","gJS","gJf","gKE","gKM","gKV","gLA","gLm","gM0","gMB","gMU","gN","gO3","gP","gP1","gPO","gPu","gQ0","gQg","gQv","gS","gT8","gTq","gUQ","gUV","gUj","gVl","gXO","gXt","gZf","ga4","gbP","gbx","gcC","geT","gey","gf8","gfN","gfY","gi9","giO","gig","gih","gjL","gjO","gjb","gkU","gkc","gkd","gkp","gl0","gmH","gmW","goc","gor","gq6","gqn","grZ","gt5","gtL","guD","guR","gvH","gwd","gwk","gwl","gxr","gyP","gyT","gzP","gzZ","h","h8","hV","hc","hr","i","i3","i4","iU","iw","j","jh","jx","k","k0","kO","l8","lj","m","mK","n","nB","nC","nH","nP","ni","oB","oE","oW","oX","oZ","od","pU","pZ","pr","q1","qZ","rJ","sAd","sB","sBb","sCT","sCb","sCd","sCj","sDg","sEX","sG1","sG3","sG6","sHs","sIt","sJS","sKM","sKV","sLA","sM0","sMB","sMU","sN","sO3","sP","sPO","sPu","sQ0","sQv","sS","sT8","sTq","sUQ","sXO","sXt","sa4","sbP","scC","seT","sf8","sfN","sfY","sig","sih","sjL","sjO","sjb","skU","skc","skd","skp","smH","soc","sq6","st5","stL","suD","suR","svH","swd","swk","swl","sxr","syP","syT","szZ","t","tZ","tg","tt","u","u8","vs","w","wE","wL","wR","wg","x3","xo","y0","yN","yZ","yc","yn","yq","yu","yx","yy","z2","zV"]
$.Au=[C.q0,H.Dg,{"":H.bu},C.jd,H.LZ,{"":H.UI},C.hG,A.ir,{created:A.oa},C.HI,H.Pg,{"":H.aR},C.Bm,A.XP,{created:A.XL},C.tH,E.Ws,{created:E.MZ},C.hg,W.hd,{},C.ri,W.yy,{}]
...
if($desc instanceof Array)$desc=$desc[1]
ak.prototype=$desc
ak.prototype.gih=function(receiver){return receiver.color}
ak.prototype.sih=function(receiver,v){return receiver.color=v}
...
if($desc instanceof Array)$desc=$desc[1]
Sa.prototype=$desc
function Ws(Cb,wl,XO,O3,MU,PO,yP,wk,uR,AP,fn,AP,fn,nV,dn,HX,JF,Fj,MK,Wm,pM){this.Cb=Cb
this.wl=wl
this.XO=XO
this.O3=O3
this.MU=MU
...
if($desc instanceof Array)$desc=$desc[1]
Ws.prototype=$desc
Ws.prototype.gCb=function(receiver){return receiver.Cb}
Ws.prototype.gCb.$reflectable=1
Ws.prototype.sCb=function(receiver,v){return receiver.Cb=v}
Ws.prototype.sCb.$reflectable=1
Ws.prototype.gwl=function(receiver){return receiver.wl}
Ws.prototype.gwl.$reflectable=1
Ws.prototype.swl=function(receiver,v){return receiver.wl=v}
Ws.prototype.swl.$reflectable=1
Ws.prototype.gXO=function(receiver){return receiver.XO}
Ws.prototype.gXO.$reflectable=1
Ws.prototype.sXO=function(receiver,v){return receiver.XO=v}
Ws.prototype.sXO.$reflectable=1
Ws.prototype.gO3=function(receiver){return receiver.O3}
Ws.prototype.gO3.$reflectable=1
Ws.prototype.sO3=function(receiver,v){return receiver.O3=v}
Ws.prototype.sO3.$reflectable=1
Ws.prototype.gMU=function(receiver){return receiver.MU}
Ws.prototype.gMU.$reflectable=1
Ws.prototype.sMU=function(receiver,v){return receiver.MU=v}
Ws.prototype.sMU.$reflectable=1
Ws.prototype.gPO=function(receiver){return receiver.PO}
Ws.prototype.gPO.$reflectable=1
Ws.prototype.sPO=function(receiver,v){return receiver.PO=v}
Ws.prototype.sPO.$reflectable=1
Ws.prototype.gyP=function(receiver){return receiver.yP}
Ws.prototype.gyP.$reflectable=1
Ws.prototype.syP=function(receiver,v){return receiver.yP=v}
Ws.prototype.syP.$reflectable=1
Ws.prototype.gwk=function(receiver){return receiver.wk}
Ws.prototype.gwk.$reflectable=1
Ws.prototype.swk=function(receiver,v){return receiver.wk=v}
Ws.prototype.swk.$reflectable=1
Ws.prototype.guR=function(receiver){return receiver.uR}
Ws.prototype.guR.$reflectable=1
Ws.prototype.suR=function(receiver,v){return receiver.uR=v}
Ws.prototype.suR.$reflectable=1
function LP(){}LP.builtin$cls="LP"
if(!"name" in LP)LP.name="LP"
$desc=$collectedClasses.LP
if($desc instanceof Array)$desc=$desc[1]
...
if($desc instanceof Array)$desc=$desc[1]
VD.prototype=$desc
return[qE,SV,